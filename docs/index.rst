...
notoriously lighter on battery than what it replaces — your phone might
actually survive until bedtime. Revolutionary concept, we know.)* 🔋 This
project is built on the principle that open-source software can be powerful,
accessible, and — as this very documentation hopes to prove — occasionally
funny.
