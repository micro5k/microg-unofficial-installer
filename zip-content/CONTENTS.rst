...
Common
------
- **files/priv-app/GmsCore.apk** => microG Service Core 0.2.8.17785-2-vtm-8a0010a (on Android >= 4) |fire|
- **files/priv-app-legacy/GmsCore.apk** => microG Service Core 0.2.6.13280 (on Android < 4) |fire|
