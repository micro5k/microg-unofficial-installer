...
DEVICE_LOSETUP="$(command -v losetup)" || DEVICE_LOSETUP=''
...
readonly PREVIOUS_PATH DEVICE_TWRP DEVICE_GETPROP DEVICE_MOUNT DEVICE_LOSETUP DEVICE_DUMPSYS DEVICE_STAT DEVICE_PM DEVICE_AM DEVICE_APPOPS
export PREVIOUS_PATH DEVICE_TWRP DEVICE_GETPROP DEVICE_MOUNT DEVICE_LOSETUP DEVICE_DUMPSYS DEVICE_STAT DEVICE_PM DEVICE_AM DEVICE_APPOPS
