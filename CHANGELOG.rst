...
==========================
- Add support for mounting system partition at /mnt/system (`@storm1ng <https://github.com/storm1ng>`__)
- Improve compatibility with legacy shells
- Fix remounting system as read-write
- Rewrite system mounting code
- Fix debug log path when sideloading (thanks `@storm1ng <https://github.com/storm1ng>`__ for the help)
- Auto-root if needed in :code:`zip-install.sh`
- Update microG Service Core to 0.2.27.223616 (now using MapLibre)
- Add full support for automounting A/B slot partitions (thanks `@storm1ng <https://github.com/storm1ng>`__ for the help)
- Add full support for automounting dynamic partitions (thanks `@storm1ng <https://github.com/storm1ng>`__ for the help)
